...
const TERMO_AREA_ALIANCAS_BUILT_JUR_4 = `
...
export const TERM_CONFIG: Record<TermKey, {
  ...
  area_aliancas: {
    title: "Termo de Acesso à Área de Alianças BUILT",
    label: "Termo de Acesso à Área de Alianças BUILT",
    version: "BUILT JUR - 4",
    body: TERMO_AREA_ALIANCAS_BUILT_JUR_4,
    icon: Shield,
  },
  vitrine: {
    title: "Termo de Acesso e Uso da Vitrine Pública BUILT",
  ...
  built_capital: {
    title: "Termo de Acesso à Área de Parceiros de Capital BUILT",
