...
- Meu Perfil abre em uma central resumida com a previa completa no topo e quatro categorias abaixo; progresso e proxima etapa aparecem somente enquanto houver pendencias. Cada editor exibe apenas os campos da categoria escolhida, reutiliza o mesmo estado de formulario e preserva os salvamentos e endpoints existentes. Em Conta e seguranca, a alteracao de senha aparece antes do convite e do resumo tanto no desktop quanto no mobile.
