...
export const companyPlanSubscriptions = pgTable("company_plan_subscriptions", {
  ...
  billing_suspended: boolean("billing_suspended").notNull().default(false),
...
export const transferenciasCotas = pgTable("transferencias_cotas", {
  ...
  valor_total: numeric("valor_total", { precision: 18, scale: 5 }),
  percentual_transferencia: numeric("percentual_transferencia", { precision: 8, scale: 5 }),
  status: text("status").notNull().default("pendente"),
